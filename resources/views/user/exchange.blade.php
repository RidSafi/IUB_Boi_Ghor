    ...
    <div class="limiter">
      ...
      >
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
          <form class="login100-form validate-form" action="{{ url('insert-exchange') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <span class="login100-form-title p-b-49"> Exchange </span>
            ...
            <div class="wrap-input100" style="margin-top: 5px">
              ...
              <div class="wrap-input100" style="margin-top: 5px">
                <textarea class="input100" placeholder="Address.." name="address"></textarea>
              </div>
            <span>Image</span>
            <div class="wrap-input100" style="margin-top: 5px">
              <input
            ...
            <div class="container-login100-form-btn" style="margin-top: 10px">
              <div class="wrap-login100-form-btn">
                ...
                <button type="submit" class="login100-form-btn">Post</button>
              </div>
            </div>
          </form>
        </div>
